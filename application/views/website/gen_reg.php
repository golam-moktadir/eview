        ...
        <div class="row">
            ...
            <div class="span9">
                ...
                <table class="table table-bordered">
                    <tr><th style="text-align: center;">General Member Registration</th></tr>
                    <td>
                        <form id="gen_reg_form">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="mobile"><b>Picture</b></label>
                                <div class="controls">
                                    <input id="picture" name="picture" placeholder="Your Picture" type="file">
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <button type="submit" id="gen_reg" class="btn btn-success">SUBMIT </button>
                                </div>
                            </div>
                        </form>				  
                    </td>
...
<script>
$("#gen_reg_form").on("submit", function (e) {
  e.preventDefault();
  if (confirm("Are you sure?")) {
      ...
      if (email == "" || address == "" || name == "" || mobile == "" || password == "" || country == "") {
          alert("Please fill up all info");
      } else {
          var url = "<?php echo base_url() ?>Insert_data/gen_reg";
          $.ajax({
              url: url,
              type: "post",
              dataType: "json",
