...
#checkboxes label:hover {
  background-color: #1e90ff;
                ...
                <table class="table table-bordered">
                    <tr><th style="text-align: center;">Merchant Member Registration</th></tr>
                    <td>
                        <form action="<?php echo base_url().'Insert_data/mer_reg'?>" enctype='multipart/form-data' method='post'>
                            ...
                            <div class="form-group col-sm-2 col-xs-12">
                                ...
                                <select name="category" id="category" class="form-control selectipcker"
                                        data-container="body">
                                    <option value="">-- Select --</option>
                                    <?php foreach ($cat as $single_category) { ?>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="name"><b>Company Name</b></label>
                                <div class="controls">
                                    <input id="name" name="name" placeholder="Your Company Name" type="text">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="picture"><b>Picture</b></label>
                                <div class="controls">
                                    <input id="picture" name="picture" type="file">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="res_person"><b>Responsible Person</b></label>
                                <div class="controls">
                                    <input id="res_person" name="res_person" placeholder="Your  Name" type="text">
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="mobile"><b>Password</b></label>
                                <div class="controls">
                                    <input id="password" name="password" placeholder="Give any password" type="text">
                                </div>
                            </div>

                            <div class="control-group">
                                <div class="controls">
                                    <input type="submit" id="gen_reg" name="submit" value="SUBMIT" class="btn btn-success">
                                </div>
                            </div>
                        </form>				  
                    </td>
...
$("#mer_reg_form").on("submit", function (e) {
  e.preventDefault();
  if (confirm("Are you sure?")) {
      var category = $("#category").val().trim();
      var sub_category = $("#sub_category").val().trim();
      var res_person = $("#res_person").val().trim();
      ...
      if (category == "" || sub_category == "" || res_person == "" || 
              country == "" || email == "" || address == "" || name == "" || mobile == "" || password == "") {
          alert("Please fill up all info");
      } else {
          var url = "<?php echo base_url() ?>Insert_data/mer_reg";
          $.ajax({
              url: url,
              type: "post",
             // dataType: "json",
