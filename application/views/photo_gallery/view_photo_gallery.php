            ...
            foreach ($all_value as $single_value) {
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <?php if (file_exists('./assets/img/photo_gallery/' . $single_value->picture)) { ?>
                        <a href="<?php echo base_url(); ?>assets/img/photo_gallery/<?php echo $single_value->picture; ?>" target="_blank"><img src="<?php echo base_url(); ?>assets/img/photo_gallery/<?php echo $single_value->picture; ?>"
