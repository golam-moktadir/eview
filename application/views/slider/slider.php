...
<script>
    ...
    $("#slider_form").on("submit", function (e) {
        ...
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Insert_data/slider";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function edit_data(id) {
        var url = "<?php echo base_url() ?>Get_data/slider";
        $.ajax({
            url: url,
            type: "post",
            dataType: "json",
    ...
    $("#click_edit").on("click", function () {
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Edit_data/slider";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
                data: new FormData($('#slider_form')[0]),
                processData: false,
                contentType: false,
                success: function (data) {
                    $("#slider_form")[0].reset();
    ...
    function delete_data(id) {
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Delete_data/slider";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function view() {
        $.ajax({
            url: "<?php echo base_url() ?>View_data/slider",
            dataType: "json",
            success: function (data) {
