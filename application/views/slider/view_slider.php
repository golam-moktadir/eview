            ...
            foreach ($all_value as $single_value) {
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <?php if (file_exists('./assets/img/slider/' . $single_value->picture)) { ?>
                        <a href="<?php echo base_url(); ?>assets/img/slider/<?php echo $single_value->picture; ?>" target="_blank"><img src="<?php echo base_url(); ?>assets/img/slider/<?php echo $single_value->picture; ?>"
