                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <strong><label for="details">Contact Details</label></strong>
                                        <textarea type="text" name="details" class="form-control"  id="details" rows="15" cols="4"></textarea>
                                    </div>
                                </div>
...
<script>
    ...
    $("#contact_form").on("submit", function (e) {
        ...
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Insert_data/contact";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function edit_data(id) {
        var url = "<?php echo base_url() ?>Get_data/contact";
        $.ajax({
            url: url,
            type: "post",
            dataType: "json",
    ...
    $("#click_edit").on("click", function () {
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Edit_data/contact";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function delete_data(id) {
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Delete_data/contact";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function view() {
        $.ajax({
            url: "<?php echo base_url() ?>View_data/contact",
            dataType: "json",
            success: function (data) {
