...
<script>
    ...
    function change_status(id, status_value) {
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Edit_data/change_status_product";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
                data: {'id': id, 'status_value': status_value, 'db_name': "cus_req"},
    ...
    function delete_data(id) {
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Delete_data/cus_req";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function view() {
        $.ajax({
            url: "<?php echo base_url() ?>View_data/cus_req",
            dataType: "json",
            success: function (data) {
