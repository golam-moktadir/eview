                            ...
                            <div class="row">
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        <strong><label for="about">About Us</label></strong>
                                        <textarea type="text" required="" name="about" class="form-control"  id="about" rows="10" cols="5"></textarea>
                                    </div>
                                </div>
...
<script>
    ...
    $("#about_form").on("submit", function (e) {
        ...
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Insert_data/about";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function edit_data(id) {
        var url = "<?php echo base_url() ?>Get_data/about";
        $.ajax({
            url: url,
            type: "post",
            dataType: "json",
    ...
    $("#click_edit").on("click", function () {
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Edit_data/about";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
                data: new FormData($('#about_form')[0]),
                processData: false,
                contentType: false,
                success: function (data) {
                    $("#about_form")[0].reset();
    ...
    function delete_data(id) {
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Delete_data/about";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function view() {
        $.ajax({
            url: "<?php echo base_url() ?>View_data/about",
            dataType: "json",
            success: function (data) {
