...
<script>
    ...
    $("#brand_form").on("submit", function (e) {
        ...
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Insert_data/brand";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function edit_data(id) {
        var url = "<?php echo base_url() ?>Get_data/brand";
        $.ajax({
            url: url,
            type: "post",
            dataType: "json",
    ...
    $("#click_edit").on("click", function () {
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Edit_data/brand";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function delete_data(id) {
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Delete_data/brand";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function view() {
        $.ajax({
            url: "<?php echo base_url() ?>View_data/brand",
            dataType: "json",
            success: function (data) {
