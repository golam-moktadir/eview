    ...
    <tbody>
        ...
        foreach ($all_value as $single_value) {
            ...
            <tr>
                ...
                <td style="text-align: center;"><?php echo $single_value->department_name; ?></td>
                <td style="text-align: center;"  class="no_print">
                    ...
                    <?php } ?>
                    <?php if (!in_array("15", $edit_id) || !in_array("15", $delete_id) || !in_array("all", $edit_id) || !in_array("all", $delete_id)) { ?>
                    <b>N/A</b>
                    <?php } ?>
                </td>
            </tr>
