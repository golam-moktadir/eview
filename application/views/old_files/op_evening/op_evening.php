                    ...
                    <div class="box-body">
                        <p style="font-size: 20px; margin: 0px; padding: 0px; 
                           color: green; font-weight: bolder; text-align: center;">
                            Receipt for Operation's Charge Evening
                        </p>
                        <div class="row">
                            <form id="receipt_form">
                                ...
                                <div class="form-group col-sm-1 col-xs-4" style="padding-left: 0px; margin-left: 0px; padding-top: 26px; ">
                                    <a href="<?php echo base_url(); ?>Show_form/patient/ope" title="Add Patient"
...
<script>
    ...
    $("#confirm_btn").click(function () {
        ...
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Insert_data/op_receipt_ev";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function delete_data(id) {
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Delete_data/op_account_ev";
            $.ajax({
                url: url,
                type: "post",
                dataType: "json",
    ...
    function view() {
        $.ajax({
            url: "<?php echo base_url() ?>View_data/op_account_ev",
            dataType: "json",
            success: function (data) {
    ...
    function show_rec_op_ev(id) {
        var url = "<?php echo base_url() ?>Insert_data/show_rec_op_ev/" + id;
        $.ajax({
            url: url,
            type: "post",
            dataType: "json",
