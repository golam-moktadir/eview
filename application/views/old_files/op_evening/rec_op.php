...
<div style="text-align: right; padding-right: 0px;" class="no_print">
    ...
    <a href="<?php echo base_url(); ?>Show_form/op_evening" 
    ...
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4 col-xs-12" style="text-align: center; border: 1px solid black; padding-top: 8px; width: 250px;">
                 <?php foreach ($all_bank as $single_value) { if($single_value->acc_type=="Evening"){?>
        ...
        <div class="row">
            <div class="form-group col-sm-12 col-xs-12" 
                 style="text-align: left; font-size: 15px; font-weight: bold; padding-bottom: 0px; margin-bottom: 0px;">
                <p >SL No: <?php echo date('Y', strtotime($all_rec[0]->date))."-".$all_rec[0]->unique_id; ?> </p>
            </div>
        </div>

        <div class="row">
            <div class="form-group col-sm-6 col-xs-12" style="text-align: left; font-size: 15px; font-weight: bold; padding-bottom: 0px; margin-bottom: 0px;">
        ...
        <div class="row">
            <div class="form-group col-sm-4 col-xs-12" style="text-align: left; font-size: 15px; font-weight: bold; padding-bottom: 0px; margin-bottom: 0px;">
