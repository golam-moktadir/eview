...
<script>
    view();
    $("#unit_name_form").on("submit", function (e) {
        e.preventDefault();
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Insert_data/unit_name";
...
//                    },
    ...
    function delete_data(id){
        if (confirm("Are you sure?")) {
            var url = "<?php echo base_url() ?>Delete_data/unit_name";
            $.ajax({
                url: url,
                type: "post",
                dataType:"json",
...
//                    },
    ...
    function view(){
        $.ajax({
            url: "<?php echo base_url() ?>View_data/unit_name",
            dataType: "json",
            success: function (data) {
