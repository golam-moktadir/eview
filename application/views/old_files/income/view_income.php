    ...
    <tbody>
        ...
        foreach ($all_value as $single_value) {
            ...
            <tr>
                    ...
                    <!--<td style="text-align: center;"><?php echo $single_value->ac_type; ?></td>-->
                    ...
                    <?php if (in_array("10", $edit_id) || in_array("all", $edit_id)) { ?>
                    ...
                    <?php } ?>
                    <?php if (!in_array("10", $edit_id) && !in_array("10", $delete_id) && !in_array("all", $edit_id) &&
